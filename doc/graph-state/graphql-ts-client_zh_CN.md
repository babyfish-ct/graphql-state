# [graphql-state](https://github.com/babyfish-ct/graphql-state)/[文档](../README_zh_CN.md)/[图状态](./README_zh_CN.md)/整合graphql-ts-client

## 1. 添加依赖

如果项目要使用图状态，除graphql-state外，还需要导入[graphql-ts-client](https://github.com/babyfish-ct/graphql-ts-client)。
```
...
[graphql-ts-client](https://github.com/babyfish-ct/graphql-ts-client)是一个强类型的DSL，需要进行代码生成工作。
