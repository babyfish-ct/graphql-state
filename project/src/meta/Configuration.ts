...
export interface Configuration<TSchema extends SchemaType> {
    ...
    >(
        ...
        properties: {
            readonly contains: (
                row: ScalarRow<TSchema["entities"][TTypeName][" $scalarTypes"]>,
                variables: TSchema["entities"][TTypeName][" $associationArgs"][TFieldName]
            ) => boolean | undefined,
            readonly position?: (
                row: ScalarRow<TSchema["entities"][TTypeName][" $scalarTypes"]>,
                rows: ReadonlyArray<ScalarRow<TSchema["entities"][TTypeName][" $scalarTypes"]>>,
                variables: TSchema["entities"][TTypeName][" $associationArgs"][TFieldName]
            ) => PositionType | undefined,
            readonly dependencies: (
                variables: TSchema["entities"][TTypeName][" $associationArgs"][TFieldName]
            ) => ReadonlyArray<keyof TSchema["entities"][TTypeName][" $scalarTypes"]> | undefined
        }
    ): this;
