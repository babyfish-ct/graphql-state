...
export interface TypeConfiguration<TConfigurationSchema extends ConfigurationSchemaTypes, TName extends keyof TConfigurationSchema["objectTypes"] | keyof TConfigurationSchema["collectionTypes"] | keyof TConfigurationSchema["edgeTypes"]> {
    superType<XSuperName extends keyof TConfigurationSchema["objectTypes"]>(superName: XSuperName): this;
    id<TFieldName extends keyof TConfigurationSchema["objectTypes"][TName]>(name: TFieldName): this;
    ...
    list<TFieldName extends keyof TConfigurationSchema["objectTypes"][TName], TElementTypeName extends keyof TConfigurationSchema["objectTypes"]>(name: TFieldName, elementTypeName: TElementTypeName, options?: CollectionTypeName<TConfigurationSchema, TElementTypeName>): this;
    ...
    mappedBy<TFieldName extends keyof TConfigurationSchema["objectTypes"][TName]>(fieldName: TFieldName, oppositeFieldName: string): this;
}
