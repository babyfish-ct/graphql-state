...
export interface Configuration<TConfigurationSchema extends ConfigurationSchemaTypes> {
    ...
    addConnectionType<TObjectType extends ObjectType, TName extends string>(objectTypeRef: TypeRef<TObjectType, TName>): Configuration<TConfigurationSchema & {
        collectionTypes: {
            readonly [key in TName]: TObjectType;
        };
    }>;
    addEdgeType<TObjectType extends ObjectType, TName extends string>(objectTypeRef: TypeRef<TObjectType, TName>): Configuration<TConfigurationSchema & {
        edgeTypes: {
            readonly [key in TName]: TObjectType;
        };
    }>;
    setObjectType<TTypeName extends keyof TConfigurationSchema["objectTypes"] & string>(typeName: TTypeName, typeConfigurer: (tc: TypeConfiguration<TConfigurationSchema, TTypeName>) => void): this;
