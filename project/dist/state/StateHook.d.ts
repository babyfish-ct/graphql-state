...
export declare function useStateManager<TSchema extends ScheamType>(): StateManager<TSchema>;
...
export declare function makeManagedObjectHooks<TSchema extends ScheamType>(): ManagedObjectHooks<TSchema>;
