...
export declare type AsyncReturnType<T, TAsyncStyle extends AsyncStyles> = TAsyncStyle extends "async-object" ? UseStateAsyncValueHookResult<T> : TAsyncStyle extends "refetchable-suspense" ? [
    T,
    () => void
] : T;
export declare type AsyncStyles = "suspense" | "refetchable-suspense" | "async-object";
