...
export declare class StateManagerImpl<TSchema extends SchemaType> implements StateManager<TSchema> {
    ...
    evict<TName extends keyof TSchema["entities"] & string>(typeName: TName, idOrArray?: TSchema["entities"][TName][" $id"] | ReadonlyArray<TSchema["entities"][TName][" $id"] | undefined> | undefined, fieldOrArray?: any): void;
