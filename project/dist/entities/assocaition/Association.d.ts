...
import { GraphField, RefetchReasonType } from "../../state/Monitor";
export declare class Association {
    ...
    evict(entityManager: EntityManager, args: VariableArgs | undefined, includeMoreStrictArgs: boolean, refetchReason?: RefetchReasonType): void;
